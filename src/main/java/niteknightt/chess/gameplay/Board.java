    ...
    protected void _undoMove(Move move) {
        ...
        if (lastMove.isPromotion()) {
            ...
            if (lastMove.isCapture()) {
                _pieces.set(endIndex, Piece.createPiece(move.pieceTypeCaptured(), Enums.Color.oppositeColor(move.color()), move.target().col, move.target().row, this));
            }
            else {
            ...
            _pieces.set(Position.internalToIndex(locationOfCapturedPawn), Piece.createPiece(Enums.PieceType.PAWN, Enums.Color.oppositeColor(move.color()), locationOfCapturedPawn.col, locationOfCapturedPawn.row, this));
            _pieces.set(endIndex, Piece.GetBlankPiece());
        }
        else {
            _pieces.set(startIndex, _pieces.get(endIndex));
